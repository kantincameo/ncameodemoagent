# Urinalysis Analyzer — Skill Package
...
├── README.md                         ← this file
├── references/
│   ├── BloomCell_Urinalysis.xlsx     ← ground-truth sheet (19 markers)
...
same scripts, same output schema — just pointed at the urinalysis ground-truth sheet instead
of the bloodwork one.

## How this skill uses the Excel sheet

`references/BloomCell_Urinalysis.xlsx` has 5 columns per marker: **Marker Name, Internal
Notes, Explanation, 30-Day Plan, Long-Term Plan** — covering Color, Clarity/Turbidity, Specific
Gravity, pH, Protein, Glucose, Ketones, Blood (Hemoglobin), Leukocyte Esterase, Nitrites,
Bilirubin, Urobilinogen, RBCs, WBCs, Epithelial Cells, Casts, Crystals, Bacteria/Yeast, Mucus.
...
1. Just replace `references/BloomCell_Urinalysis.xlsx` with your new file (keep the same
   filename).
