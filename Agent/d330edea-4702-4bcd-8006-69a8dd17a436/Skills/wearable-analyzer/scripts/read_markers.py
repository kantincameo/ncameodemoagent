...
If no path given, defaults to references/BloomCell_Wearable_markers.xlsx
...
DEFAULT_PATH = os.path.join(SKILL_ROOT, "references", "BloomCell_Wearable_markers.xlsx")
